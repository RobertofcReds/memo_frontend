...
import styles from './css/pageStyles.module.css'; // Je recommande d'utiliser .module.css
...
const NotFound = () => {
  ...
  return (
    <div className={styles["not-found-container"]}>
      ...
      {/* Hero Section avec fond bleu/noir et étoiles */}
      <section className={`${styles["not-found-hero"]} ${styles["construction-hero"]}`}>
        ...
        <div className={styles["hero-content"]}>
          <div className={styles["construction-icon"]}>
          ...
          <h1 className={styles["anime-text"]}>
            <span className={styles["text-gradient"]}>
              Page en <span className={styles["text-highlight"]}>construction</span>
            </span>
          </h1>
          ...
          <p className={styles["hero-description"]}>
            ...
            Revenez très bientôt pour découvrir toutes les nouveautés !
          </p>

          <div className={styles["action-buttons"]}>
            <Link to="/" className={`${styles["action-button"]} ${styles["primary"]}`}>
              <i className="fas fa-home"></i>
              <span>Retour à l'accueil</span>
              <div className={styles["button-glow"]}></div>
            </Link>

            <Link to="/regions" className={`${styles["action-button"]} ${styles["secondary"]}`}>
              <i className="fas fa-map-marked-alt"></i>
          ...
          <div className={styles["progress-indicator"]}>
            ...
            <span className={styles["progress-text"]}>Développement : 75%</span>
          </div>
        </div>
      </section>
